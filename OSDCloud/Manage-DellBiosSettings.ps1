...
#Parameters ===================================================================================================================
$LogFile = "$ENV:ProgramData\ConfigJonScripts\Dell\Manage-DellBiosSettings.log"
<#
param(
...
if ($manufacturer -like "Alienware*"){
    Write-Output "This is an Alienware computer, exiting"
    exit 0
}
